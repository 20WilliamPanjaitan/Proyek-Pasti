                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                        <a href=../acara>Daftar Sektor</a> </li> <li class="breadcrumb-item active"
                                            aria-current="page">
                                            <a>Edit Sektor</a>
                                </li>
                            </ol>
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Sektor</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('edit.sektor', $data['ID']) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')

                                    <div class="form-group row">
                                        <label for="nama_sektor" class="col-sm-2 col-form-label">Nama Sektor</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="nama_sektor" name="nama_sektor"
                                                value="{{ $data['nama_sektor'] }}" required>
                                        </div>
                                    </div>
