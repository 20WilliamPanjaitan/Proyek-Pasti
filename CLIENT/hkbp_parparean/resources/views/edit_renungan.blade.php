                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow col-xl-10 col-md-6 mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Renungan</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('edit.renungan', $data['ID']) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label for="isi_renungan" class="col-sm-2 col-form-label">isi_renungan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="isi_renungan" name="isi_renungan"
                                            value="{{ $data['isi_renungan'] }}" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="ayat_renungan" class="col-sm-2 col-form-label">ayat_renungan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="ayat_renungan" name="ayat_renungan"
                                            value="{{ $data['ayat_renungan'] }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select form-control" id="status" name="status" autofocus>
