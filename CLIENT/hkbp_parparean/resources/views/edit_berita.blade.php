                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                        <a href=../acara>Daftar Berita</a> </li> <li class="breadcrumb-item active"
                                            aria-current="page">
                                            <a>Edit Berita</a>
                                </li>
                            </ol>
                        ...
                        <div class="card shadow col-xl-10 col-md-6 mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit Daftar Berita</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('edit.berita', $data['ID']) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="keterangan" value="{{ $data['keterangan'] }}"></textarea>
                                        </div>
                                    </div>
